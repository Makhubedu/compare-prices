...
class ShopriteData:
    def __init__(self, category,*args, **kwargs):
        ...
        self.html = requests.get(f"https://www.shoprite.co.za/search?q={category}").text
    ...
    def getImages(self):
        ...
        for image in images:
            source_image.append("https://www.shoprite.co.za"+image.find('img')['data-src'])
        return source_image
    ...
    def getLinks(self):
        source_link =[]
        links = self.soup.findAll('div',class_='item-product__image')
        for link in links:
            new_link = "https://www.shoprite.co.za"+link.find('a')['href']
